...
def main():
    ...
    # Train the model
    model.fit([train_sequences, train_sequences], train_targets, epochs=50, 
              batch_size=32, validation_split=0.3, callbacks=[early_stopping])
    ...
    adversarial_train(model, discriminator, train_sequences, seq_length, 
        feature_dim, epochs=100, batch_size=32, cross_entropy=cross_entropy, 
