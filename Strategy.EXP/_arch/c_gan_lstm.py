...
# Function to create the primary discriminator model with LSTM and self-attention
def create_discriminator(input_dim, conditioning_dim, lay1, lay2, lay3, sequence_length):
    ...
    x = LSTM(lay3, return_sequences=True, kernel_initializer=init)(x)
    #x = LeakyReLU(negative_slope=0.2)(x)
    #x = BatchNormalization()(x)
    #x = Dropout(0.3)(x)
...
if __name__ == "__main__":
    ...
    discriminator = create_discriminator(input_dim, conditioning_dim, 64, 32, 16, sequence_length)
