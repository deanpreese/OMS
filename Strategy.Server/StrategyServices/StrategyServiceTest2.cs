...
{  
    ...
    public StrategyServiceTest2(ILogger<StrategyServiceTest2> logger, IncomingOrderQueue strategyOrderQueue) 
    {
    ...
    public override Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        _strategyAccount.strategy_traderId = new Random().Next(3000, 5000);
   ...
   protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    ...
    private async Task Distribute()    
    {
         while (await flowBuffer.OutputAvailableAsync()) 
        {
            ...
            Console.WriteLine("2 +++ " +  _strategyAccount.strategy_traderId + " " + _itemCount );
