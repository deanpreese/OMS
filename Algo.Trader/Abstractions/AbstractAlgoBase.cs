...
public abstract class AbstractAlgoBase : IAlgo 
{
    ...
    public AbstractAlgoBase(IGrainFactory grainFactory, AlgoData algoData) 
    {
    ...
    public async Task<NewOrder> GenerateAlgoOrder(LiveOrder _orig_live_order)
    {
        ...
        _filters = AddFilters(await _trader_grain.GetProfileAsync(_trader_key), await _trader_grain.GetScoreCardAsync(_trader_key));
    ...
    public abstract List<IAlgoFilter>  AddFilters(UserProfile userProfile, ScoreCard scoreCard);
